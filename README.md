...
Atualmente foco em:
- Construir projetos práticos com **Data Science e IA**
- Desenvolver **automações inteligentes**
- Aprimorar habilidades em **programação, estatística e negócios**
- Criar soluções que transformam **dados em decisões**
